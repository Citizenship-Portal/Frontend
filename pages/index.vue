    ...
    <div class="grid-container tw-flex-1 tw-w-full tw-flex tw-flex-col tw-mx-auto tw-items-center" id="main-content">
      <div class="tw-container tw-p-6 md:tw-max-w-md lg:tw-max-w-lg">
        ...
        <div class="tw-mt-6 tw-flex tw-flex-col tw-space-y-6 tw-items-center md:tw-flex-row md:tw-justify-center md:tw-space-y-0 md:tw-justify-between ">
          ...
          <nuxt-link to="/signin">
            <button class="usa-button">Current
              Account
            </button>
          </nuxt-link>
        </div>
    ...
    <Modal :open="open" @close="accept">
      <div class="tw-max-w-xl tw-w-full tw-bg-white tw-rounded-lg tw-shadow-2xl tw-px-6 tw-py-6 tw-mx-auto">
        <h2 class="font-semibold text-gray-90 tw-text-4xl tw-leading-tight tw-border-b-2 tw-border-gray-20 tw-pb-4">
          Please Read</h2>
        <p class="tw-mt-4 tw-text-gray-70 tw-text-xl tw-leading-relaxed">This is NOT an official site of the US
          Government in any way. This is a demo
          concept of an idea <a href="https://twitter.com/andrewyang/status/1262012732402028547">proposed by Andrew
            Yang</a>.</p>
        <div class="tw-mt-6">
